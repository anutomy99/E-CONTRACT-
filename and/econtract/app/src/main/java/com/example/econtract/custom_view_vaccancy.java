...
import java.util.ArrayList;
    ...
    public class custom_view_vaccancy extends BaseAdapter {
        ...
        public custom_view_vaccancy(Context applicationContext, ArrayList<String> a, ArrayList<String> b) {
...
//            this.e=e;
        ...
        public View getView(int position, View convertview, ViewGroup parent) {
            ...
            if(convertview==null)
            {
                ...
                gridView=inflator.inflate(R.layout.activity_custom_view_vaccancy, null);
