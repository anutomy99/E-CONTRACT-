...
public class custom_request_status extends BaseAdapter {
    ...
    public custom_request_status(Context applicationContext, ArrayList<String> a, ArrayList<String> b, ArrayList<String> c) {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_custom_request_status, null);
        ...
        TextView tv3=(TextView)gridView.findViewById(R.id.textView71);
